function getDepartment() {
    const URL = 'https://tutorbook.herokuapp.com/api/get-department';
...
function getCourses(dept) {
    ...
    const URL = `https://tutorbook.herokuapp.com/api/get-courses?deptName=${dept}`;
...
function getStudentInfo(studentRollNo) {
    const URL = `https://tutorbook.herokuapp.com/api/getStudentInfo?studentRollNo=${studentRollNo}`;
